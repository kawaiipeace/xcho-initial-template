                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1"><Link href="/">{t('แดชบอร์ด')}</Link></span>
                            </div>
                        </button>
                    </li>
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1"><Link href="/">{t('กล่องขาเข้า')}</Link></span>
                            </div>
                        </button>
                    </li>
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1"><Link href="/">{t('ฟอร์มของคุณ')}</Link></span>
                            </div>
                        </button>
                    </li>
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1"><Link href="/">{t('เทมเพลต')}</Link></span>
                            </div>
                        </button>
                    </li>
                </ul>
